...
type SendRedPacketReq struct {
	...
	UserId          string `protobuf:"bytes,1,opt,name=userId,proto3" json:"userId,omitempty"`                    //用户id,群红包时为群id
...
var file_cloud_wallet_proto_rawDesc = []byte{
	...
	0x69, 0x76, 0x65, 0x64, 0x10, 0xec, 0x07, 0x32, 0xae, 0x09, 0x0a, 0x12, 0x43, 0x6c, 0x6f, 0x75,
	...
	0x63, 0x6b, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x42, 0x10, 0x5a, 0x0e, 0x2e, 0x3b, 0x63, 0x6c,
	0x6f, 0x75, 0x64, 0x5f, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_cloud_wallet_proto_depIdxs = []int32{
	...
	22, // 34: cloud_wallet.CloudWalletService.SendRedPacket:input_type -> cloud_wallet.SendRedPacketReq
	26, // 35: cloud_wallet.CloudWalletService.ClickRedPacket:input_type -> cloud_wallet.ClickRedPacketReq
	3,  // 36: cloud_wallet.CloudWalletService.UserNcountAccount:output_type -> cloud_wallet.UserNcountAccountResp
	42, // 37: cloud_wallet.CloudWalletService.IdCardRealNameAuth:output_type -> cloud_wallet.IdCardRealNameAuthResp
	15, // 38: cloud_wallet.CloudWalletService.SetPaymentSecret:output_type -> cloud_wallet.SetPaymentSecretResp
	6,  // 39: cloud_wallet.CloudWalletService.CloudWalletRecordList:output_type -> cloud_wallet.CloudWalletRecordListResp
	9,  // 40: cloud_wallet.CloudWalletService.BindUserBankcard:output_type -> cloud_wallet.BindUserBankcardResp
	11, // 41: cloud_wallet.CloudWalletService.BindUserBankcardConfirm:output_type -> cloud_wallet.BindUserBankcardConfirmResp
	13, // 42: cloud_wallet.CloudWalletService.UnBindingUserBankcard:output_type -> cloud_wallet.UnBindingUserBankcardResp
	46, // 43: cloud_wallet.CloudWalletService.UserRecharge:output_type -> cloud_wallet.UserRechargeResp
	21, // 44: cloud_wallet.CloudWalletService.UserWithdrawal:output_type -> cloud_wallet.drawAccountResp
	38, // 45: cloud_wallet.CloudWalletService.ChargeNotify:output_type -> cloud_wallet.chargeNotifyResp
	40, // 46: cloud_wallet.CloudWalletService.WithDrawNotify:output_type -> cloud_wallet.drawNotifyResp
	23, // 47: cloud_wallet.CloudWalletService.SendRedPacket:output_type -> cloud_wallet.SendRedPacketResp
	27, // 48: cloud_wallet.CloudWalletService.ClickRedPacket:output_type -> cloud_wallet.ClickRedPacketResp
