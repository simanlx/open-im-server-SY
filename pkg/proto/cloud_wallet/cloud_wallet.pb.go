...
var file_cloud_wallet_proto_rawDesc = []byte{
	...
	0x52, 0x52, 0x54, 0x68, 0x69, 0x72, 0x64, 0x50, 0x61, 0x79, 0x10, 0xf0, 0x2e, 0x2a, 0x33, 0x0a,
	0x17, 0x50, 0x61, 0x79, 0x43, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x42, 0x75, 0x73, 0x69,
	0x6e, 0x65, 0x73, 0x73, 0x54, 0x79, 0x70, 0x65, 0x12, 0x08, 0x0a, 0x04, 0x45, 0x4d, 0x4f, 0x4b,
	0x10, 0x00, 0x12, 0x0e, 0x0a, 0x0a, 0x50, 0x5f, 0x54, 0x68, 0x69, 0x72, 0x64, 0x50, 0x61, 0x79,
	0x10, 0x64, 0x32, 0xba, 0x12, 0x0a, 0x12, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x57, 0x61, 0x6c, 0x6c,
	...
	0x50, 0x61, 0x79, 0x43, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x42,
...
var file_cloud_wallet_proto_msgTypes = make([]protoimpl.MessageInfo, 67)
...
var file_cloud_wallet_proto_depIdxs = []int32{
	...
	4,  // 33: cloud_wallet.CloudWalletService.UserNcountAccount:input_type -> cloud_wallet.UserNcountAccountReq
	46, // 34: cloud_wallet.CloudWalletService.IdCardRealNameAuth:input_type -> cloud_wallet.IdCardRealNameAuthReq
	18, // 35: cloud_wallet.CloudWalletService.SetPaymentSecret:input_type -> cloud_wallet.SetPaymentSecretReq
	20, // 36: cloud_wallet.CloudWalletService.CheckPaymentSecret:input_type -> cloud_wallet.CheckPaymentSecretReq
	7,  // 37: cloud_wallet.CloudWalletService.CloudWalletRecordList:input_type -> cloud_wallet.CloudWalletRecordListReq
	10, // 38: cloud_wallet.CloudWalletService.BindUserBankcard:input_type -> cloud_wallet.BindUserBankcardReq
	14, // 39: cloud_wallet.CloudWalletService.BindUserBankcardConfirm:input_type -> cloud_wallet.BindUserBankcardConfirmReq
	16, // 40: cloud_wallet.CloudWalletService.UnBindingUserBankcard:input_type -> cloud_wallet.UnBindingUserBankcardReq
	50, // 41: cloud_wallet.CloudWalletService.UserRecharge:input_type -> cloud_wallet.UserRechargeReq
	12, // 42: cloud_wallet.CloudWalletService.UserRechargeConfirm:input_type -> cloud_wallet.UserRechargeConfirmReq
	24, // 43: cloud_wallet.CloudWalletService.UserWithdrawal:input_type -> cloud_wallet.drawAccountReq
	42, // 44: cloud_wallet.CloudWalletService.ChargeNotify:input_type -> cloud_wallet.chargeNotifyReq
	44, // 45: cloud_wallet.CloudWalletService.WithDrawNotify:input_type -> cloud_wallet.drawNotifyReq
	26, // 46: cloud_wallet.CloudWalletService.SendRedPacket:input_type -> cloud_wallet.SendRedPacketReq
	30, // 47: cloud_wallet.CloudWalletService.ClickRedPacket:input_type -> cloud_wallet.ClickRedPacketReq
	52, // 48: cloud_wallet.CloudWalletService.ForbidGroupRedPacket:input_type -> cloud_wallet.ForbidGroupRedPacketReq
	35, // 49: cloud_wallet.CloudWalletService.RedPacketReceiveDetail:input_type -> cloud_wallet.RedPacketReceiveDetailReq
	32, // 50: cloud_wallet.CloudWalletService.RedPacketInfo:input_type -> cloud_wallet.RedPacketInfoReq
	54, // 51: cloud_wallet.CloudWalletService.CloudWalletRecordDel:input_type -> cloud_wallet.CloudWalletRecordDelReq
	56, // 52: cloud_wallet.CloudWalletService.GetVersion:input_type -> cloud_wallet.getVersionReq
	58, // 53: cloud_wallet.CloudWalletService.RefoundPacket:input_type -> cloud_wallet.RefoundPacketReq
	60, // 54: cloud_wallet.CloudWalletService.ThirdPay:input_type -> cloud_wallet.ThirdPayReq
	63, // 55: cloud_wallet.CloudWalletService.CreateThirdPayOrder:input_type -> cloud_wallet.CreateThirdPayOrderReq
	65, // 56: cloud_wallet.CloudWalletService.GetThirdPayOrderInfo:input_type -> cloud_wallet.GetThirdPayOrderInfoReq
	67, // 57: cloud_wallet.CloudWalletService.PayConfirm:input_type -> cloud_wallet.PayConfirmReq
	68, // 58: cloud_wallet.CloudWalletService.PayCallback:input_type -> cloud_wallet.PayCallbackReq
	5,  // 59: cloud_wallet.CloudWalletService.UserNcountAccount:output_type -> cloud_wallet.UserNcountAccountResp
	47, // 60: cloud_wallet.CloudWalletService.IdCardRealNameAuth:output_type -> cloud_wallet.IdCardRealNameAuthResp
	19, // 61: cloud_wallet.CloudWalletService.SetPaymentSecret:output_type -> cloud_wallet.SetPaymentSecretResp
	21, // 62: cloud_wallet.CloudWalletService.CheckPaymentSecret:output_type -> cloud_wallet.CheckPaymentSecretResp
	8,  // 63: cloud_wallet.CloudWalletService.CloudWalletRecordList:output_type -> cloud_wallet.CloudWalletRecordListResp
	11, // 64: cloud_wallet.CloudWalletService.BindUserBankcard:output_type -> cloud_wallet.BindUserBankcardResp
	15, // 65: cloud_wallet.CloudWalletService.BindUserBankcardConfirm:output_type -> cloud_wallet.BindUserBankcardConfirmResp
	17, // 66: cloud_wallet.CloudWalletService.UnBindingUserBankcard:output_type -> cloud_wallet.UnBindingUserBankcardResp
	51, // 67: cloud_wallet.CloudWalletService.UserRecharge:output_type -> cloud_wallet.UserRechargeResp
	13, // 68: cloud_wallet.CloudWalletService.UserRechargeConfirm:output_type -> cloud_wallet.UserRechargeConfirmResp
	25, // 69: cloud_wallet.CloudWalletService.UserWithdrawal:output_type -> cloud_wallet.drawAccountResp
	43, // 70: cloud_wallet.CloudWalletService.ChargeNotify:output_type -> cloud_wallet.chargeNotifyResp
	45, // 71: cloud_wallet.CloudWalletService.WithDrawNotify:output_type -> cloud_wallet.drawNotifyResp
	27, // 72: cloud_wallet.CloudWalletService.SendRedPacket:output_type -> cloud_wallet.SendRedPacketResp
	31, // 73: cloud_wallet.CloudWalletService.ClickRedPacket:output_type -> cloud_wallet.ClickRedPacketResp
	53, // 74: cloud_wallet.CloudWalletService.ForbidGroupRedPacket:output_type -> cloud_wallet.ForbidGroupRedPacketResp
	36, // 75: cloud_wallet.CloudWalletService.RedPacketReceiveDetail:output_type -> cloud_wallet.RedPacketReceiveDetailResp
	33, // 76: cloud_wallet.CloudWalletService.RedPacketInfo:output_type -> cloud_wallet.RedPacketInfoResp
	55, // 77: cloud_wallet.CloudWalletService.CloudWalletRecordDel:output_type -> cloud_wallet.CloudWalletRecordDelResp
	57, // 78: cloud_wallet.CloudWalletService.GetVersion:output_type -> cloud_wallet.getVersionResp
	59, // 79: cloud_wallet.CloudWalletService.RefoundPacket:output_type -> cloud_wallet.RefoundPacketResp
	61, // 80: cloud_wallet.CloudWalletService.ThirdPay:output_type -> cloud_wallet.ThirdPayResp
	64, // 81: cloud_wallet.CloudWalletService.CreateThirdPayOrder:output_type -> cloud_wallet.CreateThirdPayOrderResp
	66, // 82: cloud_wallet.CloudWalletService.GetThirdPayOrderInfo:output_type -> cloud_wallet.GetThirdPayOrderInfoResp
	3,  // 83: cloud_wallet.CloudWalletService.PayConfirm:output_type -> cloud_wallet.CommonResp
	69, // 84: cloud_wallet.CloudWalletService.PayCallback:output_type -> cloud_wallet.PayCallbackResp
